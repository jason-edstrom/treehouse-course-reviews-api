package io.instacode.treehouse.java.core;

import io.instacode.treehouse.java.course.Course;
import io.instacode.treehouse.java.course.CourseRepository;
...
public class DatabaseLoader implements ApplicationRunner {
  ...
  public void run(ApplicationArguments args) throws Exception {
    ...
    courses.save(course);
    String[] templates = { "Up and Running with %s", "%s Basics", "%s for Beginners", "%s for Neckbeards",
        "Under the hood: %s" };
    String[] buzzwords = { "Spring REST Data", "Java 9", "Scala", "Groovy", "Hibernate" };
